...
**GoRouter** هي مكتبة routing رسمية من فريق Flutter، بتوفرلك طريقة declarative للتنقل بين الصفحات في تطبيقك. المكتبة دي مبنية على **Navigator 2.0 API** بس بتخلي استخدامه أسهل بكتير.
